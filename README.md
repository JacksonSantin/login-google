...
<p align="center">
  <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/JacksonSantin/login-google?color=%238257E5">

  <img alt="GitHub top language" src="https://img.shields.io/github/languages/top/JacksonSantin/login-google?color=%238257E5">
...
**Login Google** - Aplicação desenvolvida para praticar o básico da programação, html, css, javascript, flexbox e também para implementar o login do Google e entender seu funcionamento.
...
Este projeto esta sobe a licença [MIT](https://github.com/JacksonSantin/login-google/blob/master/LICENSE).
